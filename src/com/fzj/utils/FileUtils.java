...
public class FileUtils {
	...
	public static Map<String, Integer> readBasicInfo(String f_str_path,String f_str_filename){
		...
		try {
			...
			t_aTC_map.put(NameSpace.s_str_n, Integer.parseInt(t_rstr_s[0]));
			t_aTC_map.put(NameSpace.s_str_m, Integer.parseInt(t_rstr_s[1]));
			t_aTC_map.put(NameSpace.s_str_r, Integer.parseInt(t_rstr_s[2]));
