...
public class WWOStrategy extends AStrategy {
	...
	private void propagate(WaveSolution f_aTC_wave) {
		...
		for(int t_aI4_j=0;t_aI4_j<m_aI4_d;t_aI4_j++){
			...
			double t_aI8_y = t_aI4_xd+Math.ceil(t_aI8_r*t_aI8_w*m_rI8_range[t_aI4_j]);
			int t_aI4_temp = new Double(t_aI8_y).intValue();
	...
	private void initPopulation2(){
		for(int t_aI4_i=0;t_aI4_i<m_aI4_size;t_aI4_i++){
			...
			t_aTC_wave.setM_rI4_v(t_aTC_wave.getM_rI4_x());
		}
	}
...
//			printSolution(m_aTC_worst);
	...
	public static void main(String[] args) {
		...
		AStrategy t_aTC_strategy = new WWOStrategy(10, 1000, 500, t_aTC_ssm, NameSpace.s_str_data_01);
